<template>
    <div class="mb-2">
        ...
        <b-collapse v-if="getDefaultValue" v-model="translation.expanded" role="tabpanel" visible>
        ...
        <b-alert v-else show variant="danger">
            No default translation could be found for: <strong>{{ translation.translationKey }}</strong>. In the main file (e.g. locallang.xlf) only English may be defined as the language. Check <a href="https://docs.typo3.org/m/typo3/reference-coreapi/8.7/en-us/Internationalization/Introduction/" target="_blank">this link</a>.
        </b-alert>
    </div>
</template>
